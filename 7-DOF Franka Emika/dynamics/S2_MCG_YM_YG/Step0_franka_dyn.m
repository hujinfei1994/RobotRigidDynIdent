...
%% def betaM betaG
beta_str    = {'beta1','beta2','beta3','beta4','beta5','beta6','beta7','beta8','beta9','beta10','beta11','beta12','beta13','beta14','beta15','beta16','beta17','beta18','beta19','beta20','beta21','beta22','beta23','beta24','beta25','beta26','beta27','beta28','beta29','beta30','beta31','beta32','beta33','beta34','beta35','beta36','beta37','beta38','beta39','beta40','beta41','beta42','beta43'};
beta    = [beta1,beta2,beta3,beta4,beta5,beta6,beta7,beta8,beta9,beta10,beta11,beta12,beta13,beta14,beta15,beta16,beta17,beta18,beta19,beta20,beta21,beta22,beta23,beta24,beta25,beta26,beta27,beta28,beta29,beta30,beta31,beta32,beta33,beta34,beta35,beta36,beta37,beta38,beta39,beta40,beta41,beta42,beta43];
...
U325=DV235 + WP15;
U335=DV115 + DV225;
VSP15=L2.*U114 + L6.*U124 + VP14;
VSP25=L2.*U214 + L6.*U224 + VP24;
VSP35=L2.*U314 + L6.*U324 - VSP24;
...
N26=-(FDI37.*L3) - N37 + No26 + mz6.*VP16 + mx6.*VP25;
N36=-(F37.*L3) + C7.*N27 + No36 + N17.*S7 - my6.*VP16 + mx6.*VP26;
FDI16=C6.*E16 - E26.*S6;
FDI36=C6.*E26 + E16.*S6;
E15=F15 + FDI16;
E25=-E36 + F25;
...
E24=E35 + F24;
E34=F34 + FDI35;
N14=FDI35.*L6 + C5.*N15 + No14 - N25.*S5 - mz4.*VP24 - my4.*VSP24;
N24=-(FDI35.*L2) + N35 + No24 + mz4.*VP14 + mx4.*VSP24;
N34=E35.*L2 - FDI15.*L6 - C5.*N25 + No34 - N15.*S5 - my4.*VP14 + mx4.*VP24;
FDI14=C4.*E14 - E24.*S4;
FDI34=C4.*E24 + E14.*S4;
E13=F13 + FDI14;
E23=-E34 + F23;
N13=C4.*N14 + No13 - N24.*S4 - mz3.*VP23 - my3.*VSP23;
N23=-(FDI34.*L1) - N34 + No23 + mz3.*VP13 + mx3.*VSP23;
N33=-(E34.*L1) + C4.*N24 + No33 + N14.*S4 - my3.*VP13 + mx3.*VP23;
FDI13=C3.*E13 - E23.*S3;
FDI33=C3.*E23 + E13.*S3;
N12=-(FDI33.*L5) + C3.*N13 + No12 - N23.*S3 - mz2.*VP22;
N22=-N33 + No22 + mz2.*VP12;
N32=FDI13.*L5 + C3.*N23 + No32 + N13.*S3 - my2.*VP12 + mx2.*VP22;
N31=-(C2.*N22) - N12.*S2;
H1=N31;
H2=N32;
H3=N33;
...
%% get cg
tic
dq = [qd1;qd2;qd3;qd4;qd5;qd6;qd7];
ddq = [qdd1;qdd2;qdd3;qdd4;qdd5;qdd6;qdd7];
cg(1)=(H1);
cg(2)=(H2);
cg(3)=(H3);
cg(4)=(H4);
...
Y_show
franka_getY = matlabFunction(Y)
save franka_getY.mat franka_getY
