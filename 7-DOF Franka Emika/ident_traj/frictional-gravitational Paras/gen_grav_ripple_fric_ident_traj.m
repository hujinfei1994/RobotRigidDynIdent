...
dlmwrite(['franka_data_read_grav_rip_fric_ident_J',num2str(jnt),'.txt'],save_data);
save(['time_grav_rip_fric_ident_J',num2str(jnt),'.mat'],'save_T_neg2pos','save_T_pos2neg','save_T0','vel_data','vel_num','T_total')
