...
extern double q1, q2, q3, q4, q5, q6, mx6, my6, I6xx, I6xy;
extern double I6yy, I6xz, I6yz, I5xx, I5xy, I5xz, I5yy, I6zz, I5yz, I5zz;
extern double mx5, my5, mz6, mz5, m5, m6, I4xx, I4xy, I4xz, I4yy;
extern double I4yz, I4zz, mx4, my4, mz4, m4, L5, L4, I3xx, I3xy;
extern double I3xz, I3yy, I3yz, I3zz, mx3, my3, mz3, m3, L3, I2xx;
extern double I2xy, I2xz, I2yy, I2yz, I2zz, mx2, my2, mz2, m2, L1;
extern double I1xx, I1xy, I1xz, I1yy, I1yz, I1zz, mx1, my1, mz1, m1;
extern double Ia1, Ia2, Ia3, Ia4, Ia5, Ia6;

/* Declaration of global output variables */
extern double S1, C1, S2, C2, S3, C3, S4, C4, S5, C5;
extern double S6, C6, AS16, AS36, AJ116, AJ126, AJ136, AJ316, AJ326, AJ336;
extern double AJA116, AJA216, AJA316, AJA336, XXP5, XYP5, XZP5, YYP5, YZP5, ZZP5;
extern double MXP5, MYP5, MZP5, MP5, AS15, AS35, AJ115, AJ125, AJ135, AJ215;
extern double AJ225, AJ315, AJ325, AJ335, AJA115, AJA215, AJA315, AJA335, XXP4, XYP4;
extern double XZP4, YYP4, YZP4, ZZP4, MXP4, MYP4, MZP4, MP4, AS14, AS34;
extern double AJ114, AJ124, AJ134, AJ214, AJ224, AJ314, AJ324, AJ334, AJA114, AJA214;
extern double AJA314, AJA334, PAS114, PAS124, PAS214, PAS224, PAS314, PAS324, PAS334, XXP3;
extern double XYP3, XZP3, YYP3, YZP3, ZZP3, MXP3, MYP3, MZP3, MP3, AS13;
extern double AS23, AJ113, AJ123, AJ133, AJ213, AJ223, AJ233, AJ313, AJ323, AJA113;
extern double AJA213, AJA313, AJA223, AJA323, PAS213, PAS223, PAS313, PAS333, XXP2, XYP2;
extern double XZP2, YYP2, YZP2, ZZP2, MXP2, MYP2, MZP2, MP2, AS12, AS32;
extern double AJ112, AJ122, AJ132, AJ212, AJ222, AJ312, AJ322, AJ332, AJA112, AJA212;
extern double AJA312, AJA332, PAS212, PAS222, PAS312, PAS332, XXP1, XYP1, XZP1, YYP1;
extern double YZP1, ZZP1, MXP1, MYP1, MZP1, MP1, EB12, EB32, NB22, EC12;
extern double EC22, NC32, EC13, EC33, NC13, NC23, NC33, ED12, ED32, ND12;
extern double ND22, ND32, ED13, ED23, ND13, ND23, ND33, ED14, ED34, ND14;
extern double ND24, ND34, EE12, EE32, EE13, EE33, NE13, NE23, NE33, EE14;
extern double EE24, NE14, NE24, NE34, EE15, EE35, NE15, NE25, NE35, EF12;
extern double EF32, EF13, EF33, NF13, NF33, EF14, EF34, NF14, NF24, NF34;
extern double EF15, EF25, NF15, NF25, NF35, EF16, EF36, NF16, NF26, NF36;
extern double A[7][7];

/* Declaration of the function */
void racer3_52_paras_inm()
{
	...
	XXP3=AJA114 + I3xx + (L5*L5)*MP4 - 2*PAS114;
	XYP3=AJA214 + I3xy - L4*L5*MP4 - PAS124 - PAS214;
	XZP3=AJA314 + I3xz - PAS314;
	YYP3=I3yy + (L4*L4)*MP4 - 2*PAS224 + ZZP4;
	YZP3=AJ334 + I3yz - PAS324;
	ZZP3=AJA334 + I3zz + ((L4*L4) + (L5*L5))*MP4 - 2*PAS334;
	...
	YYP2=AJA223 + I2yy + (L3*L3)*MP3 - 2*PAS223;
	YZP2=AJA323 + I2yz;
	ZZP2=I2zz + (L3*L3)*MP3 - 2*PAS333 + ZZP3;
	...
	YYP1=I1yy + (L1*L1)*MP2 - 2*PAS222 + ZZP2;
	YZP1=AJ332 + I1yz;
	ZZP1=AJA332 + I1zz + (L1*L1)*MP2 - 2*PAS332;
