%% jnt = 3
% 待测试轴为3轴(jnt)，匀速往复；随动加减速轴为1轴(ax)，优化出来的轨迹。
...
dlmwrite(['racer3_data_read_inertial_ident_J',num2str(jnt),'_B.txt'],save_data);
save(['time_inertial_ident_J',num2str(jnt),'_B.mat'],'save_T_neg2pos','save_T_pos2neg','index_p2n','index_n2p_number','index_p2n_number','index_n2p','save_T0','acc_data','acc_num','T_total')
