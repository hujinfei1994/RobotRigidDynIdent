...
HKA_STATUS TRAJ_SCURVE_get_time_pos_vel_acc(const TRAJ_INPUT *input, const HKA_F64 T[7], const HKA_F64 t, TRAJ_TRAJ *traj)
{
...
void mexFunction (int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    sts = TRAJ_SCURVE_get_time_pos_vel_acc(&input, ptr_T, t, &traj);
